    ...
    <div className="p-5 border rounded-lg my-5">
      <div className="flex gap-2 items-center">
        {/* <Image src={post?.createdBy?.image}
                ...
                /> */}
        <div className="w-14 h-14 text-white font-mono text-2xl bg-white rounded-full flex justify-center items-center">
          <svg
        ...
        <div>
          <h2 className="font-bold">
            {post?.createdBy?.name ? post.createdBy.name : "Unknown User"}
          </h2>
      ...
      <div className="bg-lime-50 p-3 mt-4 rounded-lg">
        ...
        <div className="mt-5">
          ...
          <div className="flex gap-4 items-center">
            ...
            <input
              ...
              className="w-full bg-lime-100 p-2 rounded-full 
